      ...
      <main>
        <section className="grid grid-rows-[1fr_max-content_max-content] h-[calc(100vh-78px)]">
          <div className="flex flex-col items-center justify-center text-center p-5 lg:p-[8%]">
            <h1 className="text-7xl lg:text-8xl py-2 font-poppins font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 to-blue-700 animate-text">Ryan Than</h1>
            <h2 className="text-xl lg:text-3xl py-2 font-bold font-raleway">Developer and Designer</h2>
